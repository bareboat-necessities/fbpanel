...
docker exec --privileged -ti $DOCKER_CONTAINER_ID apt-get -y install libgtk2.0-dev libxmu-dev libxpm-dev libasound2-dev python python-argparse dh-exec autotools-dev autoconf
